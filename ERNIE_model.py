...
class ERNIE_Config(object):
    ...
    def __init__(self):
        ...
        self.model_name = "ernie-2-base-en"
...
class ERNIE_Model(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        # ERNIE / BERT-like 模型通常有 pooler_output
...
class ERNIE_LoRA_Model(nn.Module):

    def __init__(self, data_config, model_config):
        super(ERNIE_LoRA_Model, self).__init__()
        ...
        # 4. ERNIE 是 BERT-like 结构，默认只对 query/value 插入标准 LoRA
        ...
        # 5. 注入 LoRA
        self.inject_lora_to_ernie(self.bert)
    ...
    def inject_lora_to_ernie(self, module, prefix=""):
        ...
        for name, child in list(module.named_children()):
            ...
            if isinstance(child, nn.Linear) and self.is_lora_target(full_name):
                ...
                self.inject_lora_to_ernie(child, full_name)
